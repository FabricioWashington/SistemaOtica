...
import DTO.Cadastro.CadastroReceitaExameDTO;
...
public class VetorReceita {
    ...
    public void restaurarDadosCbxReceita() {
        try {
            CadastroReceitaExameDTO cadastroReceitaExameDTO = new CadastroReceitaExameDTO();
    ...
    private ResultSet listarReceitas(CadastroReceitaExameDTO cadastroReceitaExameDTO) {
