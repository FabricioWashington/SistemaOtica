...
import DAO.Cadastro.CadastroOrdemServicoDAO;
...
public class CadastroOrdemServico {
    ...
    private int idCliente, idMedico, idFuncionario, idReceita, idProduto;
    ...
    private CadastroOrdemServicoDTO cadastroOrdemServicoDTO;
    private CadastroOrdemServicoDAO cadastroOrdemServicoDAO;
    
    public CadastroOrdemServico() {
        this.cadastroOrdemServicoDAO = new CadastroOrdemServicoDAO();
        this.cadastroOrdemServicoDTO = new CadastroOrdemServicoDTO();
    }
    
    public CadastroOrdemServico(int idCliente, int idMedico, int idFuncionario, int idReceita, int idProduto, String tipoServico,
