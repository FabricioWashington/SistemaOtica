...
import DAO.Cadastro.CadastroClienteDAO;
import DAO.Conexao.ConexaoDAO;
import DTO.Cadastro.CadastroClienteDTO;
...
public class CadastroCliente {
    ...
    private String cpf;
    private CadastroPessoaJuridicaDTO cadastroPessoaJuridicaDTO;
    private CadastroPessoaFisicaDTO cadastroPessoaFisicaDTO;
    ...
    public CadastroCliente() {
        ...
        cadastroPessoaJuridicaDTO = new CadastroPessoaJuridicaDTO();
        cadastroPessoaFisicaDTO = new CadastroPessoaFisicaDTO();
        validador = new Validacoes();
        obterDataAtual();
    }

    // Construtor PF
    public CadastroCliente(String nome, int idDDD, String logradouro, String bairro, String numero, String complemento,
    ...
    public void cadastrarPJ() {
        ...
        // Cadastro PJ
        cadastroPessoaJuridicaDTO.setNomeFantasia(getNomeFantasia());
        cadastroPessoaJuridicaDTO.setCnpj(getCnpj());
        cadastroPessoaJuridicaDTO.setInscricaoEstadual(getInscricaoEstadual());
        cadastroPessoaJuridicaDTO.setInscricaoMunicipal(getInscricaoMunicipal());
