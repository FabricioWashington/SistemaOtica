...
import Sistema.BackEnd.TelasPrincipais.Cadastro.CadastroEstoque;
...
public class CadastroProdutoEstoqueView extends JDialog {
    ...
    public void cadastrarProdEstoque() {
        ...
        if (indiceProdutoSelecionado > 0) {
            ...
            cadastroEstoque = new CadastroEstoque(idProduto, idCategoria, quantidade, descricao, precoUnitario);
