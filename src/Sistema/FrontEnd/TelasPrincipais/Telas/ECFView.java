...
public class ECFView extends javax.swing.JFrame {
    ...
    public ECFView(UsuarioLogado usuarioLogado) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnFinanceiro_Auditoria.setToolTipText("");
        ...
        jLabel2.setText("> ECF - Escrituração Contabil Fiscal");
        ...
        setSize(new java.awt.Dimension(1698, 827));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ECFView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
