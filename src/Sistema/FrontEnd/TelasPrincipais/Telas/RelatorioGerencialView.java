...
public class RelatorioGerencialView extends javax.swing.JFrame {

    private UsuarioLogado usuarioLogado;
    private Timer timer;

    public RelatorioGerencialView() {

    }

    public RelatorioGerencialView(UsuarioLogado usuarioLogado) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("> Relatorio gerencial");
        ...
        setSize(new java.awt.Dimension(1658, 827));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioGerencialView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioGerencialView().setVisible(true);
            }
        });
    }
