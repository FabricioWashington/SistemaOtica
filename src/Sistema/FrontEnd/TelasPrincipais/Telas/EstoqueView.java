...
public class EstoqueView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnControleDeEstoque.setBackground(new java.awt.Color(255, 255, 255));
        btnControleDeEstoque.setForeground(new java.awt.Color(0, 0, 0));
        btnControleDeEstoque.setToolTipText("");
        btnControleDeEstoque.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnControleDeEstoqueActionPerformed(evt);
            }
        });
        ...
        jLabel5.setText("<html> <center> Controle <br/> de <br/> Estoque <center/> <html/>");
        ...
        setSize(new java.awt.Dimension(1627, 827));
    ...
    private void btnControleDeEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnControleDeEstoqueActionPerformed
        // Chamar tela Controle de estoque
        ControleDeEstoqueView controleEstoque = new ControleDeEstoqueView(usuarioLogado);
        controleEstoque.setVisible(true);
        dispose();
    }//GEN-LAST:event_btnControleDeEstoqueActionPerformed
    ...
    private javax.swing.JButton btnControleDeEstoque;
