...
import Sistema.BackEnd.TelasPrincipais.Cadastro.CadastroMedico;
...
public class CadastroMedicoView extends JDialog {
    ...
    private void cadastrar() {
        ...
        cadastroMedico = new CadastroMedico(logradouro, bairro, numero, complemento, uf, uf, idDDD, municipio, telefone, telefone2, email, nome, inscricaoProfissional);
